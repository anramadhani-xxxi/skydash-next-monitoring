...
* Execute the SQL statements from the [Database Schema](https://github.com/skydashnet/skydash-next-monitoring/wiki/5.-Database-Schema) section below to create all the necessary tables.
